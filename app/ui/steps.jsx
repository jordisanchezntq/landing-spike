...
export default function StepsUI() {
    ...
    return (
        <section id="steps" className="p-10 flex justify-center">
            <div className="container">
                <h3 data-i18n="steps.title"></h3>
                <div className="container flex justify-between items-center">
                    <div className="flex flex-col gap-6">
                        <div className="flex">
                            <h4 className="text-error font-black text-style-display-2xl before:content-[''] before:block before:w-12 before:h-1.5 before:bg-[#ff4b00] before:rounded-xl">01</h4>
